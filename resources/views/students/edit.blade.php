            ...
            <div class="card p-4">
                <div class="row mb-3 d-flex justify-content-around">
                    ...
                    @if ($student->foto_wali != null)
                        <img class="" src="{{ asset('storage/foto_wali/' . $student->foto_wali) }}"
                            style="width: 300px; height:auto">
                    @else
                        <img class="" src="{{ asset('MTS2/default.png') }}">
                    @endif
                </div>
                <div class="row justify-content-center">
                    <div class="col-sm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="nisn" value="{{ $student->nisn }}" class="form-control" id="nisn"
